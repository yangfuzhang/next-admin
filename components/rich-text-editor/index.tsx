...
const baseOptions = {
  ...
  menu: {
    insert: { title: 'Insert', items: 'image multiupload link media codesample inserttable | charmap emoticons hr | pagebreak nonbreaking anchor | insertdatetime' },
  },
  plugins: [
    'advlist', 'autolink', 'link', 'image', 'multiupload', 'media', 'table',
    'charmap', 'emoticons', 'anchor', 'searchreplace', 'visualblocks',
    'code', 'codesample', 'fullscreen', 'preview', 'pagebreak', 'insertdatetime',
    'wordcount', 'help',
  ],
  toolbar: 'undo redo | ' + 'blocks fontfamily fontsize | ' +
    ...
    'link image multiupload media table | ' + 'charmap emoticons | '  +
    'code fullscreen preview print | ' + 'pagebreak anchor codesample | ' + 'removeformat help',
...
export default function RichtextEditor(props: RichtextEditorProps) {
  const { loading, defaultValue, targetFolder = `${UPLOAD_DIR}/tinymce`, onChange } = props;
  ...
  const handleSingeUpload = async (blobInfo: any) => {
    const formData = new FormData()
    ...
    <>
      {
        showEditor && (
          <Editor
            ...
            init={{ ...initOptions, skin: theme === 'dark' ? 'oxide-dark' : 'oxide' }}
